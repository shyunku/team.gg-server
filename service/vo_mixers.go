...
func SummonerMatchSummaryTeamMateMixer(d models.MatchParticipantDAO, det models.MatchParticipantDetailDAO, primaryPerkStyle, subPerkStyle int) TeammateVO {
	return TeammateVO{
		ChampionId:                     d.ChampionId,
		ChampionLevel:                  d.ChampionLevel,
		...
		Deaths:                         d.Deaths,
		Assists:                        d.Assists,
		MagicDamageDealtToChampions:    d.MagicDamageDealtToChampions,
		PhysicalDamageDealtToChampions: d.PhysicalDamageDealtToChampions,
		TrueDamageDealtToChampions:     d.TrueDamageDealtToChampions,
		TotalDamageDealtToChampions:    d.TotalDamageDealtToChampions,
		MagicDamageTaken:               d.MagicDamageTaken,
		PhysicalDamageTaken:            d.PhysicalDamageTaken,
		TrueDamageTaken:                d.TrueDamageTaken,
		TotalDamageTaken:               d.TotalDamageTaken,
		TotalHeal:                      d.TotalHeal,
		TotalHealsOnTeammates:          d.TotalHealsOnTeammates,
		Item0:                          d.Item0,
		Item1:                          d.Item1,
		Item2:                          d.Item2,
		Item3:                          d.Item3,
		...
		FirstBloodAssist:               d.FirstBloodAssist,
		FirstBloodKill:                 d.FirstBloodKill,
		...
		TotalTimeCCDealt:               d.TotalTimeCCDealt,
		NeutralMinionsKilled:           d.NeutralMinionsKilled,
		GoldSpent:                      d.GoldSpent,
		GoldEarned:                     d.GoldEarned,
		VisionScore:                    d.VisionScore,
		DetectorWardsPlaced:            det.DetectorWardsPlaced,
		SightWardsBoughtInGame:         det.SightWardsBoughtInGame,
		VisionWardsBoughtInGame:        det.VisionWardsBoughtInGame,
		DamageDealtToBuildings:         det.DamageDealtToBuildings,
		DamageDealtToObjectives:        det.DamageDealtToObjectives,
		DamageDealtToTurrets:           det.DamageDealtToTurrets,
		DamageSelfMitigated:            det.DamageSelfMitigated,
		WardsKilled:                    det.WardsKilled,
		WardsPlaced:                    det.WardsPlaced,
